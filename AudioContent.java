...
abstract public class AudioContent
{
  ...
  //Return Print INfo as a String
  public String returnprintInfo() {
	return "Title: " + title + " Id: " + id + " Year: " + year + " Type: " + type + " Length: " + length;	 
  }
  ...
  // Play the content via the audio file
	...
	public boolean contains(String searchItem) {
		...
		String year2String = Integer.toString(this.year);
		String length2String = Integer.toString(this.length);

		return this.title.toUpperCase().contains(searchItem) || this.id.toUpperCase().contains(searchItem) 
		|| this.type.toUpperCase().contains(searchItem) || this.audioFile.toUpperCase().contains(searchItem) 
		|| year2String.toUpperCase().contains(searchItem) || length2String.toUpperCase().contains(searchItem);
	}
}
