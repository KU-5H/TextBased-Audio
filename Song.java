...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	public boolean equals(Object other)
	{
		...
		if(super.equals(otherSong) && this.artist == otherSong.artist && this.composer == otherSong.composer && this.genre == otherSong.genre) {
			return true;
		}
		return false;
	}
	...
	public boolean contains(String searchItem) {
		...
		String genreString = this.genre.toString();

		return super.contains(searchItem) || this.artist.toUpperCase().contains(searchItem) 
		|| this.composer.toUpperCase().contains(searchItem) || this.lyrics.toUpperCase().contains(searchItem) 
		|| genreString.toUpperCase().contains(searchItem);
